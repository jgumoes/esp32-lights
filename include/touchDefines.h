// TODO: create default values in lights_pwm.h, and delete this file.
// project specific defines should not be in the lib directory

// TODO: these should be compiler commands
